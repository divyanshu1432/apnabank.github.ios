...
<input class="form-control" type="file" name="image"  id="Image" autocomplete="off" required>
...
<input type="file" name="Gaurantier_image" id="Gaurantier_image" autocomplete="off" required>
